...
function  parmeters_mixer() 
    if siesta.SCF.dD > 20.0 and siesta.SCF.dD >= 2.0 then
       local DM = label .. ".DM"
       os.execute("rm " .. DM)
       siesta.SCF.MaxIterations=50
       siesta.SCF.Mixer.Weight=0.001
       siesta.SCF.NumberPulay=8
       siesta.SCF.NumberKick=6
    ...
    elseif siesta.SCF.dD < 2.0 and siesta.SCF.dD > 0.1 then
       local DM = label .. ".DM"
       os.execute("rm " .. DM)
       siesta.SCF.MaxIterations=100
       siesta.SCF.Mixer.Weight=0.001
       siesta.SCF.NumberPulay=15
